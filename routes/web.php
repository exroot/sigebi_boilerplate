...
Route::get('books', 'BookController@index')->name('books');                // All books
...
Route::get('authors', 'AuthorController@index')->name('authors');            // Get all authors
...
Route::get('copies', 'BookItemController@index')->name('copies');            // Get all copies
